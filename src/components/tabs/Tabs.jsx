      ...
      <div className='tabs'>
        ...
        <div className='tabs-content'>
          <div className={tab === 1 ? 'content active' : 'content'}>
            <Chart Higher='$29939' Lower='$2,939' aspect={3 / 1} />
          </div>
          <div className={tab === 2 ? 'content active' : 'content'}>
            <Chart Higher='$9,999' Lower='$1,9939' aspect={3 / 1} />
          </div>
          <div className={tab === 3 ? 'content active' : 'content'}>
            <Chart Higher='$9,939' Lower='$2,939' aspect={3 / 1} />
          </div>
          <div className={tab === 4 ? 'content active' : 'content'}>
            <Chart Higher='$9,999' Lower='$2,993' aspect={3 / 1} />
          </div>
        </div>
      </div>
    </div>
